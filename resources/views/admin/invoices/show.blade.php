...
<body>
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <div class="bg-white p-8 rounded-3xl shadow-2xl card-bounce max-w-2xl w-full text-gray-800">
            ...
            <h1 class="text-3xl font-bold text-center text-green-700 mb-2">Invoice Detail</h1>
            <p class="text-center text-gray-600 mb-6">Please show this invoice to the receptionist 🐾</p>
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    <span>{{ $invoice->appointment->pet->user->name }}</span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-bold text-green-600">$ {{ number_format($invoice->cost, 2, '.', ',') }}</span>
                </div>
